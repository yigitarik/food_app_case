...
class MyCartView extends StatefulWidget {
  Meals? meal;
  MyCartView({super.key, this.meal});
  ...
  void initState() {
    ...
    if (preferencesService.containsKeyCheck(key: 'mycart')) {
      mealListModel = MealListModel.fromJson(
          jsonDecode(preferencesService.getStringValue(key: 'mycart')));
      if (widget.meal != null) {
        setState(() {
          mealListModel.meals.add(widget.meal!);
          var jsonString = jsonEncode(mealListModel.toJson());
          preferencesService.setStringValue(key: 'mycart', value: jsonString);
        });
      }
    }
          ...
          child: Column(
            children: [
              ...
              ListView.separated(
                  ...
                  shrinkWrap: true,
                  itemCount: mealListModel.meals.length,
                    ...
                    return Slideable(
                      ...
                      items: [
                        ActionItems(
                          icon: Icon(
                              favoriteListModel.meals.any((element) =>
                                      element.idMeal ==
                                      mealListModel.meals[index].idMeal)
                                  ? Icons.favorite
                                  : Icons.favorite_border,
                              color: AppColors.primaryColor),
                          onPress: () {
                            setState(() {
                              if (preferencesService.containsKeyCheck(
                                  key: 'favorites')) {
                                if (favoriteListModel.meals.any((element) =>
                                    element.idMeal ==
                                    mealListModel.meals[index].idMeal)) {
                                  favoriteListModel.meals.removeWhere(
                                      (element) =>
                                          element.idMeal ==
                                          mealListModel.meals[index].idMeal);
                                } else {
                                  favoriteListModel.meals
                                      .add(mealListModel.meals[index]);
                                  var jsonString =
                        ...
                        ActionItems(
                          ...
                          onPress: () {
                            setState(() {
                              mealListModel.meals.removeAt(index);

                              var jsonString =
                                  jsonEncode(mealListModel.toJson());
                              preferencesService.setStringValue(
                                  key: 'mycart', value: jsonString);
                            });
                          },
                          backgroudColor: Colors.transparent,
                        ),
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => MealDetailView(
                                    meal: mealListModel.meals[index]),
                              ));
                        },
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: ListTile(
                                  title: Text(
                                    mealListModel.meals[index].strMeal
                                        .toString(),
                                    maxLines: 2,
